package sg.edu.rp.c346.id22028460.demoweather;
        ...
        client.get("https://api.data.gov.sg/v1/environment/2-hour-weather-forecast", new JsonHttpResponseHandler() {
            ...
            protected void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    ArrayAdapter<Weather> adapter = new ArrayAdapter<>(MainActivity.this,
                            android.R.layout.simple_list_item_1, alWeather);
                    ListView lvWeather = findViewById(R.id.lvWeather);
